...
class PicturesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create picture" do
    assert_difference('Picture.count') do
      post pictures_url, params: { picture: { article_id: @picture.article_id, photo: @picture.photo } }
    end
  ...
  test "should update picture" do
    patch picture_url(@picture), params: { picture: { article_id: @picture.article_id, photo: @picture.photo } }
